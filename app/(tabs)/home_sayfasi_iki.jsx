          ...
          >
            <View style={styles.pazarlikLeft}>
              ...
              <View style={{ flex: 1, paddingRight: 8 }}>
                <Text style={styles.pazarlikUrunName} numberOfLines={1}>
                  {item.urunAdi || "İsimsiz Ürün"}
                </Text>
                <Text style={styles.pazarlikStatus}>
                  {item.botDurumMesaji || "Pazarlık Sürüyor..."}
                </Text>
              </View>
            </View>
            <View style={{ alignItems: "flex-end" }}>
              <Text style={styles.pazarlikLabel}>Son Teklif</Text>
              <Text style={styles.pazarlikPrice}>
                {item.botunSonTeklifi || "0"} ₺
              </Text>
            </View>
          </TouchableOpacity>
        ))
