/**
 * SmartDrop AI — login_sayfasi_bir.jsx
...
import { useRouter } from "expo-router"; // Expo Router yönlendirme kütüphanesi eklendi
...
export default function LoginScreen() {
  ...
  const router = useRouter(); // Yönlendirme motoru tanımlandı

  // Giriş Yap butonuna basıldığında tetiklenecek fonksiyon
  const handleLogin = () => {
    // replace kullanıyoruz ki kullanıcı giriş yaptıktan sonra geri tuşuyla tekrar login ekranına dönemesin
    router.replace("/(tabs)/home_sayfasi_iki");
  };

  // Google butonuna basıldığında tetiklenecek fonksiyon
  const handleGoogle = () => {
    router.replace("/(tabs)/home_sayfasi_iki");
  };
