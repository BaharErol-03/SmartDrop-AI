  ...
  return (
    <GestureHandlerRootView style={{ flex: 1 }}>
      ...
      >
        ...
        <Drawer.Screen name="profil_duzenle" options={{ headerShown: false, swipeEnabled: false }} />
        <Drawer.Screen name="ayarlar" options={{ headerShown: false, swipeEnabled: false }} />
        <Drawer.Screen name="yardim" options={{ headerShown: false, swipeEnabled: false }} />
      </Drawer>
